...
# adapted from pytorch/examples/vae, ethanluoyc/pytorch-vae and uhlerlab/cross-modal-autoencoders
...
#            nn.ReLU(inplace=True),
 ...
 #           nn.ReLU(inplace=True),
    ...
    #This is where we specify the class prediction output but we should change to make this an argument probs
class Simple_Classifier(nn.Module):
    """Latent space discriminator"""
    def __init__(self, nz, n_out):
...
class FC_Classifier_three(nn.Module):
    """Latent space discriminator"""
    def __init__(self, nz, n_hidden=1024, n_out=3):
        super(FC_Classifier_three, self).__init__()
        self.nz = nz
        self.n_hidden = n_hidden
        self.n_out = n_out
